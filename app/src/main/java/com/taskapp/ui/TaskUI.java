    ...
    public void inputChangeInformation() {
        ...
        while (flg) {
            try {
                ...
                String codeTask = reader.readLine();
                if (!isNumeric(codeTask)) {
                    System.out.println("コードは半角の数字で入力してください");
                    System.out.println();
                    continue;
                }
                ...
                System.out.print("選択肢：");
                String chageStatus = reader.readLine();
                if (!isNumeric(chageStatus)) {
                    System.out.println("ステータスは半角の数字で入力してください");
                    System.out.println();
                    continue;
                }
                if(!(chageStatus.equals("1") || chageStatus.equals("2"))){
                    System.out.println("ステータスは1・2の中から選択してください");
                    System.out.println();
                    continue;
                }
                
                taskLogic.changeStatus(Integer.parseInt(codeTask), Integer.parseInt(chageStatus), loginUser);
    ...
    public void inputDeleteInformation() {
        ...
        while (flg) {
            try {
                ...
                taskLogic.delete(Integer.parseInt(codeTask));
